...
const Hero = () => {
  return (
    <div className="pb-20 pt-32 md:pt-28">
      ...
      <div className="h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.09] bg-grid-black/[0.2] flex absolute top-0 left-0 items-center justify-center">
